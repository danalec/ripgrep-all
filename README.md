...
> Using rga as the search backend of an LLM agent harness? See
> [doc/harness.md](doc/harness.md) for a recommended invocation, the output
> contract, and the failure modes to expect.
